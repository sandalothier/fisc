...
import com.brain.FiscalisteApp;
import com.brain.config.audit.AuditEventConverter;
import com.brain.domain.PersistentAuditEvent;
import com.brain.repository.PersistenceAuditEventRepository;

import com.brain.service.AuditEventService;
 ...
 */
@SpringBootTest(classes = FiscalisteApp.class)
@Transactional
